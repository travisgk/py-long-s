...
def german_conversion(text):
    ...
    if len(clean_text) >= 3:
        ...
        #print(end_snippet)
        replacements_dict = _END_REPLACEMENTS[0].get(end_snippet)
    ...
    if replacements_dict is None and len(clean_text) >= 2:
        ...
        end_snippet = end_snippet.replace("ſ", UNKNOWN_S)
        #print(end_snippet)
        #print(_END_REPLACEMENTS[1])
        #for key in _END_REPLACEMENTS[1].keys():
        #    print(f"\t{key}")
        replacements_dict = _END_REPLACEMENTS[1].get(end_snippet)
    ...
    if replacements_dict is None:
        ...
        end_snippet = end_snippet.replace("ſ", UNKNOWN_S)
        #print(end_snippet)
        replacements_dict = _END_REPLACEMENTS[2].get(end_snippet)
    ...
    # runs through start replacements.
    if _SHOW_DEBUG:
        print("doing start replacements")
    indexing_letter = clean_text[0]
    start_pattern_dict = _START_REPLACEMENTS.get(indexing_letter)
